...
import { ArrowLeft, Upload, Info, AlertCircle } from "lucide-react"
...
const AdminAddVehicle = () => {
  ...
  const uploadImagesToCloudinary = async (files) => {
    ...
    const uploadedUrls = [] // Use a local array instead of a global one
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Send to the backend
      const response = await axios.post("http://localhost:1111/api/v1/admin/vehicle/new", formData, {
      ...
      successModal.innerHTML = `
        <div class="bg-white rounded-lg p-8 max-w-md w-full shadow-2xl">
          ...
          <h3 class="text-lg font-bold text-center text-gray-900 mb-2">Vehicle Added Successfully</h3>
          <p class="text-gray-600 text-center mb-6">The vehicle has been added to your fleet.</p>
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden">
          <div className="p-6 bg-indigo-600 text-white">
            <h1 className="text-2xl font-bold">
              {formStep === 1 ? "Add New Vehicle - Basic Information" : "Add New Vehicle - Additional Details"}
            </h1>
            <p className="text-indigo-100 mt-1">
              {formStep === 1
                ? "Enter the basic details of the vehicle"
                : "Add specifications and upload images of the vehicle"}
            </p>
          </div>
          ...
          <form onSubmit={formStep === 1 ? nextStep : handleSubmit} encType="multipart/form-data" className="p-6">
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 flex flex-col items-center">
                    ...
                    <p className="text-sm text-gray-500 mb-4 text-center">
                      ...
                      <br />
                      <span className="text-xs">(Minimum 2 images required)</span>
                    </p>
                    <input
                      type="file"
                      name="images"
                  ...
                  {selectedFiles.length > 0 && (
                    <div className="mt-4">
                      <p className="text-sm font-medium text-gray-700 mb-2">Selected Images ({selectedFiles.length})</p>
            ...
            <div className="flex justify-between mt-8">
              ...
              >
                {loading ? "Processing..." : formStep === 1 ? "Continue" : "Add Vehicle"}
              </button>
            </div>
          </form>
          ...
          <div className="bg-indigo-50 p-6 border-t border-indigo-100">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="font-medium text-indigo-800 mb-1">Tips for adding a vehicle</h3>
                <ul className="text-sm text-indigo-700 list-disc pl-5 space-y-1">
                  <li>Provide accurate vehicle specifications to help customers make informed decisions</li>
                  <li>Upload clear, high-quality images showing different angles of the vehicle</li>
                  <li>Include any special features or amenities in the description</li>
                  <li>Double-check the license plate number and insurance date for accuracy</li>
                </ul>
              </div>
            </div>
          </div>
