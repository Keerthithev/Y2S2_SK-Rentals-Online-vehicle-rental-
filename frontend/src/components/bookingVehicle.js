...
import { Calendar, ChevronLeft, CreditCard, Info, Loader, MapPin, Shield, X, Download, Printer } from "lucide-react"
...
const BookVehicle = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const bookingPayload = {
        ...
        additionalDrivers: Number.parseInt(bookingData.additionalDrivers),
      ...
      const response = await axios.post("http://localhost:1111/api/v1/newbook", bookingPayload, {
        headers: {
      ...
      if (response.status >= 200 && response.status < 300 && response.data.success && response.data.booking) {
        // Store the complete booking details for the confirmation page
        setBookingDetails(response.data.booking)
        setBookingSuccess(true)
        setBookingReference(response.data.booking._id || "REF123")
        setCurrentStep(3)
      } else {
  ...
  // Download booking confirmation as text file
...
Brand/Model: ${vehicle.brand} ${vehicle.model} (${vehicle.year})

RENTAL DETAILS
-------------
From: ${format(new Date(bookingData.startDate), "MMMM d, yyyy")}
To: ${format(new Date(bookingData.endDate), "MMMM d, yyyy")}
Duration: ${calculateTotalDays()} days

LOCATIONS
---------
Pickup: ${bookingData.pickUpLocation}
Return: ${bookingData.dropOffLocation}

PAYMENT INFORMATION
------------------
Total Amount: ${formatCurrency(calculateTotalAmount())}
Payment Method: ${bookingData.paymentMethod.replace("_", " ").replace(/\b\w/g, (l) => l.toUpperCase())}
      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-md">
                      <p>
                        ...
                        {format(new Date(bookingData.startDate), "MMMM d, yyyy")}
                      </p>
                      <p>
                        <span className="text-gray-600">To:</span>{" "}
                        {format(new Date(bookingData.endDate), "MMMM d, yyyy")}
                      </p>
                      <p>
                        <span className="text-gray-600">Duration:</span> {calculateTotalDays()} days
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-md">
                      <p>
                        <span className="text-gray-600">Pickup:</span> {bookingData.pickUpLocation}
                      </p>
                      <p>
                        <span className="text-gray-600">Return:</span> {bookingData.dropOffLocation}
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-md">
                      <p>
                        <span className="text-gray-600">Total Amount:</span> {formatCurrency(calculateTotalAmount())}
                      </p>
                      <p>
                        <span className="text-gray-600">Payment Method:</span>{" "}
                        {bookingData.paymentMethod.replace("_", " ").replace(/\b\w/g, (l) => l.toUpperCase())}
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="mt-6 flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            <button
              onClick={() => navigate("http://localhost:2222/uservehiclelist")}
                  ...
                  <div className="p-6">
                    ...
                    {!areDatesValid() && (
                      <div className="mt-4 p-3 bg-red-50 border-l-4 border-red-500 text-red-700">
                        <p className="text-sm">
                          <span className="font-medium">Warning:</span> The selected dates are not available or invalid.
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-6 flex justify-between">
                      <button
                        type="button"
                        onClick={prevStep}
                        className="px-6 py-2 bg-gray-200 text-gray-800 rounded-md hover:bg-gray-300 transition-colors text-base font-medium"
                      >
                        Back
                      </button>
                      <button
            ...
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-24">
              ...
              <div className="space-y-3 py-4 border-b border-gray-200">
                <div className="flex justify-between">
                  ...
                  <span>
                    {formatCurrency(vehicle?.rentPerDay || 0)} × {calculateTotalDays()} days
                  </span>
                </div>
                {bookingData.additionalDrivers > 0 && (
                  <div className="flex justify-between">
